...
public class CloseInventory extends PageFactory{
  ...
  @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"CloseInventory","CloseInventoryIOS1"}, description = "Validate the Close Inventory if all the items in an inventory are  assigned to Location and Category for Default location and default category")
	 public void INV_CI_001_Close_Inventory_All_Items_Assigned_Default_Loc_Default_Cat(CloseInventoryObject data) throws Exception {	
		...
		//verify close inventory button enabled 
 ...
 * 
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"CloseInventory","CloseInventoryIOS1"}, description = "Validate the Close Inventory if all the items in an inventory are  assigned to Location and Category for custom location and custom category")
 ...
 *
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"CloseInventory","CloseInventoryIOS1"}, description = "Validate the Close Inventory if all the items in an inventory are  assigned to Location and Category for custom location as list names and default category")
...
public void INV_CI_007_008_009_Close_Inventory_Some_Items_Not_Assigned_Assign_Expenses(CloseInventoryObject data) throws Exception {
	...
	home().verifyCloseInventoryLinkEnabled(false);
