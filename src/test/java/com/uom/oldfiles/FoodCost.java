...
public class FoodCost extends PageFactory{
    ...
    /******************************************************************************************
	  ...
	  * 
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCost","FoodCost_iOS1"}, description = "Validate food cost when the user has not had 2 inventory periods")
   ...
   /******************************************************************************************
	  ...
	  * 
	  ******************************************************************************************/
 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCost","FoodCost_iOS1"}, description = "Validate food cost when the user has only 1 inventory periods - he has done just one close")
  ...
  * 
  ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCost","FoodCost_iOS1"}, description = "Validate food cost when the user has has done 2 inventory period - Default Category  w/o Purchase")
 ...
 * 
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCost","FoodCost_iOS1"}, description = "Validate food cost when the user has has done 2 inventory period - Custom Category  w/o Purchase")
 ...
 * 
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCostAndroid_Defect","FoodCost_iOS1"}, description = "Validate food cost when the user has has done 2 inventory period - Suggested Category  with NonSysco Purchase. Also verify that in the Food Cost there are 2 views provided")
 ...
 * 
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCostAndroid_Defect","FoodCost_iOS1"}, description = "Validate food cost when the user has has done 2 inventory period - Custom Category with NonSysco Purchase. Also verify that in the Food Cost there are 2 views provided")
 ...
 * 
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCost_Defect-D-0764"}, description = "when the historic purchase is updated, the values are updated for the particular Food Cost - Default Category  with NonSysco Purchase")
 ...
 * 
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCost_Defect-D-0764"}, description = "when the historic purchase is updated, the values are updated for the particular Food Cost - Suggested Category  with NonSysco Purchase")
 ...
 * 
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCost_Defect-D-0764"}, description = "when the historic purchase is updated, the values are updated for the particular Food Cost (2 Food cost period exists) - Suggested Category  with NonSysco Purchase")
 ...
 * 
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"FoodCost","FoodCost_iOS"}, description = "Verify food cost for hot schedules customer")
