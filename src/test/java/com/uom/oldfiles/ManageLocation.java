...
public class ManageLocation extends PageFactory{
    ...
    @AfterMethod(alwaysRun=true)
	  ...
	  *  
	  ******************************************************************************************/
	 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ManageLocation","ManageLocation_iOS1","ML1711"}, description = "Add,View and Edit Location, verify default locations")
	 ...
	 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ManageLocation","ManageLocation_iOS1","ML1711"}, description = "Create and delete custom Location from Manage Locations and verify on Track inventory locations")
...
//commenting the above line of code to run the script in batch execution. Please uncomment this line of code once the issue is fixed. 
	 ...
	 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ManageLocation","ManageLocation_iOS1","ML1711"}, description = "Edit location details and verify")
	 ...
	 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ManageLocation","ManageLocation_iOS1_Defect"}, description = "Create and delete custom Location from Manage Locations and verify on Track inventory locations")
 ...
 public void INV_ML_003_CustomLocation_Name_VerifyLocations_ItemCount_View(ManageLocationObject data) throws Exception {	
	 ...
	 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ManageLocation","ManageLocation_iOS1","Rerun"}, description = "Verify user has an option to setup location once the user delete all locations")
	 ...
	 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ManageLocation","ManageLocation_iOS2","ML1711"}, description = "Verify user has an option to setup location once the user delete all locations")
 ...
 public void INV_ML_016_TI_059_CustomLoc_DeleteAllLoc_CustomCat_SetupCustomLoc_VerifyTrackInventory(ManageLocationObject data) throws Exception {	
	 ...
	 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ManageLocation","ManageLocation_iOS1","Rerun"}, description = "Edit location details and verify")
	...
	/******************************************************************************************
	 ...
	 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ManageLocation","ManageLocation_iOS1","Rerun","ML1711"}, description = "verify update location from manage location and product details from track inven")
