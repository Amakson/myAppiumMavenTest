...
public class NonSyscoPrepItems extends PageFactory{
    ...
    /******************************************************************************************
	  ...
	  * -----------------------------------------------------------------------------------------
	  ******************************************************************************************/
    @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems_Defect"}, description = "Add non sysco item to inventory with expense category not setup and no supplier list")
...
//		 nonSyscoPrepItem().verifyLocationSelected(data.strLocationName1);
    ...
    /******************************************************************************************
	  ...
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems_Defect","NonSyscoPrepItems_iOS1"}, description = "Add non sysco item to inventory with supplier list and default category")
   ...
   /******************************************************************************************
	  ...
	  ******************************************************************************************/
  @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems_Defect","NonSyscoPrepItems_iOS1"}, description = "Add non sysco item to inventory with supplier list and suggested category and customer location")
  ...
  /******************************************************************************************
	  ...
	  ******************************************************************************************/
  @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems_Defect","NonSyscoPrepItems_iOS1"}, description = "Add non sysco item to inventory with supplier list and custom category and list name as location")
	...
	//	component().setupinventorywithmuti
		...
		//close app
		 generic().closeApp();
			 ...
			 ******************************************************************************************/
			@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems_Defect","NonSyscoPrepItems_iOS2"}, description = "Add non sysco item to inventory with supplier list and custom category and custom category as location")
   ...
   /******************************************************************************************
 	  ...
 	  * -----------------------------------------------------------------------------------------
 	  ******************************************************************************************/
     @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems_Defect"}, description = "Add prep item to inventory with expense category not setup")
...
// 		 nonSyscoPrepItem().verifyLocationSelected(data.strLocationName1);
 ...
 //		 nonSyscoPrepItem().verifyProductDetailsPage();
    ...
    /******************************************************************************************
	  ...
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems","NonSyscoPrepItems_iOS2"}, description = "Add prep item to inventory with supplier list")
  ...
  @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems","NonSyscoPrepItems_iOS1"}, description = "Add prep item to inventory with supplier list")
	 ...
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems","NonSyscoPrepItems_iOS2"}, description = "Add non sysco item to inventory with supplier list and custom category and custom category as location")
...
// But this line of code needs to be removed once the issue is fixed/ this behavior is expected	 
    ...
    /******************************************************************************************
  	  ...
  	  * -----------------------------------------------------------------------------------------
  	  ******************************************************************************************/
      @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItems","NonSyscoPrepItems_iOS1"}, description = "Add prep item to inventory with expense category not setup")
...
//	 		 nonSyscoPrepItem().verifyCategorySelected(data.strCategoryName1);
	 ...
	 // But this line of code needs to be removed once the issue is fixed/ this behavior is expected	 
	     ...
	     /******************************************************************************************
	  	  ...
	  	  ******************************************************************************************/
	     @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItemss"}, description = "Add non sysco item to inventory with supplier list and default category")
	     ...
	     /******************************************************************************************
	  	  ...
	  	  ******************************************************************************************/
	     @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"NonSyscoPrepItemss"}, description = "Add prep item to inventory with supplier list and default category")
