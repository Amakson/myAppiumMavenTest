...
public class TrackInventory extends PageFactory {
	...
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory",
			"TI_Others","Rerun08112016" }, description = "Verify CustomLocations in the TrackInventory")
	...
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory"}, description = "Verify inventory setup inventory setup (Setup Custom List(Multiple List)+Default Loc+Default Cat (Items Multiple Location)")
	...
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory", "Track Inv NR",
			"TI_UOMValidation" }, description = "Verify Default Locations,Indicator and UOM and Update Quantity")
	 ...
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory",
			"TI_CustLocDefaultCat","Oct18_1" }, description = "Verify search for an item, while inventory setup using Custom location")
	 ...
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory",
			"TI_DefLocNoDependency","Oct18"  }, description = "Verify inventory setup (OG+Default Loc+Default Cat) and Item count and category for a location")
	 ...
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory",
			"TI_DefLocNoDependency" }, description = "Verify inventory setup (OG+Default Loc+Suggested12 Cat) and category for a location")
	...
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory",
			"TI_ManageLoc","Oct18" }, description = "Verify updated location name in product details for default locations")
...
//commenting since the script is already available in Manage Locations
	 ...
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory", "Track Inv NR",
			"TI_UOMValidation","Rerun08112016" }, description = "Verify update uom for both sysco and nonsysco items in default loctions")
	 ...
	 * 
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventoryInvalid",
			"TI_Defects" }, description = "Verify inventory setup (OG+Default Loc+No Cat)")
	 ...
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory",
			"TI_MultCustomLocCat","Rerun08112016"}, description = "Verify inventory setup Custom List((Custom cat)+Default Loc+Default Cat (Single Location))")
	...
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory","TI_Others"}, description = "Verify inventory setup (Custom list (Shared list)+Custom  Loc+Default Cat - Single location selection")
	 ...
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory", "Track Inv NR",
			"TI_MultCustomLocCat","Rerun08112016" }, description = "Verify inventory setup inventory setup (Setup OG+Default Loc+Suggested Cat (Items Single Location)")
	 ...
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventory", "Track Inv NR",
			"TI_MultCustomLocCat","Rerun08112016" }, description = "Verify inventory setup (OG+Custom Loc+Custom Cat)")
	...
	@Test(retryAnalyzer = RetryAnalyzer.class, dataProvider = "DP1", groups = { "TrackInventoryInvalid",
			"TI_Defects" }, description = "Verify inventory setup (OG+Custom  Loc+ Skip the Cat (Do this later) - Single location selection)")
