...
public class ManageExpenseCategories extends PageFactory{
    ...
    /******************************************************************************************
	  * Name : INV_MEC_001_004_INV_TI_035_Verify_Update_DefaultExpenseCategories_Verify_Product_Categories
	  * 
	  * Description : User should be able to verify and update default expense categories and verify the changes in categories for location items (Covering the track inventory test cases, INV_TI_035,INV_TI_038)
	  * 
	  * Manual Test cases : INV_MEC_001,INV_MEC_004,INV_TI_035
	  * 
	  ...
	  * -----------------------------------------------------------------------------------------
	  *  10/05/2016					Gayathri				Included the validations for INV_TI_035
	  ******************************************************************************************/

    @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1","CriticalBatchAndroid","CriticalPatchIOS"}, description = "Verify and Update Default Expense Categories and verify the changes in categories for location items")

	 public void INV_MEC_001_004_INV_TI_035_Verify_Update_DefaultExpenseCategories_Verify_Product_Categories(ExpenseCategoriesObject data) throws Exception {	
    ...
    /******************************************************************************************
	  * Name : INV_MEC_007_INV_TI_038_Delete_DefaultExpenseCategories_Verify_Product_Categories
	  * 
	  * Description : User should be able to delete default expense categories and verify the changes in categories for location items (Covering the track inventory test cases, INV_TI_035,INV_TI_038)
	  * 
	  * Manual Test cases : INV_MEC_007,INV_TI_038
	  * 
	  * Author : Gayathri Anand
	  * 
	  * Date : 10/03/2016
	  ...
	  * Date						Author						Description
	  * -----------------------------------------------------------------------------------------
	  *  10/05/2016					Gayathri				Included the validations for INV_TI_038
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Delete Default Expense Categories and verify the changes in categories for location items")
	 public void INV_MEC_007_INV_TI_038_Delete_DefaultExpenseCategories_Verify_Product_Categories(ExpenseCategoriesObject data) throws Exception {	
   	...
   	//Login to app
		...
		expenseCat().verifyDeleteExpenseCategoryConfirmationPopUp(data.strCategoryName1);
		//hit yes delete
		generic().tapYesDelete();
		//verify the expense categories page is loaded
		expenseCat().verifyExpenseCategoriesPage();
		//verify deleted category not in list
		 expenseCat().verifyCategoryInCategoryList(data.strCategoryName1, false);
		 //INV_TI_038
		 //tap back
		 generic().tapBack();
		 //navigate to track inventory
		 ...
		 locations().verifyCategoryOfDeletedCategoryItems(data.strCategoryName1);
		 //close app
		 generic().closeApp();
   }
    /******************************************************************************************
	  * Name : INV_MEC_002_005_INV_TI_036_Verify_Update_SuggestedExpenseCategories_Verify_Product_Categories
	  * 
	  * Description : User should be able to verify and update suggested expense categories  and verify the changes in categories for location items (Covering the track inventory test cases, INV_TI_036,INV_TI_039)
	  * 
	  * Manual Test cases : INV_MEC_002,INV_MEC_005INV_TI_036
	  * 
	  * Author : Gayathri Anand
	  * 
	  * Date : 10/03/2016
	  ...
	  *  
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Verify and Update and Suggested Expense Categories and verify the changes in categories for location items")
	 public void INV_MEC_002_005_INV_TI_036_Verify_Update_SuggestedExpenseCategories_Verify_Product_Categories(ExpenseCategoriesObject data) throws Exception {	
   ...
   /******************************************************************************************
	  * Name : INV_MEC_008_INV_TI_039_Delete_SuggestedExpenseCategories_Verify_Product_Categories
	  * 
	  * Description : User should be able to delete suggested expense categories  and verify the changes in categories for location items (Covering the track inventory test cases, INV_TI_036,INV_TI_039)
	  * 
	  * Manual Test cases : INV_MEC_008,INV_TI_039
	  * 
	  * Author : Gayathri Anand
	  * 
	  * Date : 10/03/2016
	  ...
	  *  
	  ******************************************************************************************/
 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Delete Suggested Expense Categories and verify the changes in categories for location items")
	 public void INV_MEC_008_INV_TI_039_Delete_SuggestedExpenseCategories_Verify_Product_Categories(ExpenseCategoriesObject data) throws Exception {	
	   ...
	   //setup inventory - precondition
		...
		expenseCat().tapDeleteExpenseCategory();
		//verify confirmation message
		expenseCat().verifyDeleteExpenseCategoryConfirmationPopUp(data.strCategoryName3);
		//hit yes delete
		generic().tapYesDelete();
		//verify the expense categories page is loaded
		expenseCat().verifyExpenseCategoriesPage();
		//verify deleted category not in list
		 expenseCat().verifyCategoryInCategoryList(data.strCategoryName3, false);
		//select an expense category
		expenseCat().tapCategoryFromList(data.strCategoryName5);
		//verify expense categories details page 
		expenseCat().verifyExpenseCategoryDetailsPage();
		...
		expenseCat().tapDeleteExpenseCategory();
		//verify confirmation message
		expenseCat().verifyDeleteExpenseCategoryConfirmationPopUp(data.strCategoryName5);
		//hit yes delete
		generic().tapYesDelete();
		//verify the expense categories page is loaded
		expenseCat().verifyExpenseCategoriesPage();
		//verify deleted category not in list
		 expenseCat().verifyCategoryInCategoryList(data.strCategoryName5, false);
		 //INV_TI_039
		 //tap back
		 generic().tapBack();
		 //navigate to track inventory
		 ...
		 locations().verifyCategoryOfDeletedCategoryItems(data.strCategoryName1);
		 locations().verifyCategoryOfDeletedCategoryItems(data.strCategoryName3);
		 locations().verifyCategoryOfDeletedCategoryItems(data.strCategoryName5);
		 //close app
		 generic().closeApp();
 }
   /******************************************************************************************

 	  * Name : INV_MEC_003_006_INV_TI_037_Verify_Update_CustomExpenseCategories 
 	  *  	  
 	  ...
 	  * Manual Test cases : INV_MEC_003,INV_MEC_006,INV_TI_037
 	  * 
 	  * Author : Asha
 	  * 
 	  * Date : 10/03/2016
 	  ...
 	  *  
 	  ******************************************************************************************/
    @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1","CriticalBatchAndroid"}, description = "Verify and Update Custom Expense Categories")
 	 public void INV_MEC_003_006_INV_TI_037_Verify_Update_CustomExpenseCategories(ExpenseCategoriesObject data) throws Exception {	
		//Login to app
		   component().login(data.strUserName, data.strPassword);
		   //setup inventory - precondition
    ...
    /******************************************************************************************
	  ...
	  * Name : INV_MEC_009_INV_TI_040_Delete_CustomExpenseCategories 
	  *  	  
	  * Description : User should be able to verify,update and delete custom expense categories. 
	  * and the same updation is validate in Track Inventory also
	  * Manual Test cases : INV_MEC_009,INV_TI_040
	  * 
	  * Author : Asha
	  * 
	  * Date : 10/03/2016
	  ...
	  *  
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1","CriticalBatchAndroid"}, description = "Delete Custom Expense Categories")
	 public void INV_MEC_009_INV_TI_040_Delete_CustomExpenseCategories(ExpenseCategoriesObject data) throws Exception {	
		//Login to app
		   component().login(data.strUserName, data.strPassword);
		   //setup inventory - precondition
		 component().setupInventorywithOGDefaultLocCustomCategory(data.strCategoryNames,data.strCategoryTypes);
	  ...
	  /** Name : INV_MEC_010_011_INV_TI_042_Delete_All_Custom_Categories_Setup_Default_Categories_Verify_Product_Categories
	  * 
	  * Description : User should be able to delete all custom expense categories, Set up expenses using default categories, Verify product categories
	  * 
	  ...
	  *  
	  ******************************************************************************************/
    @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS2","CriticalBatchAndroid"}, description = "_Delete All Custom Categories, Setup Default Categories, Verify Product Categories")
	 public void INV_MEC_010_011_INV_TI_042_Delete_All_Custom_Categories_Setup_Default_Categories_Verify_Product_Categories(ExpenseCategoriesObject data) throws Exception {	
 	
 		//Login to app
	   component().login(data.strUserName, data.strPassword);
	   //setup inventory - precondition -INV_SI_005
	   component().setupInventorywithOGDefaultLocCustomCategory(data.strCategoryNames,data.strCategoryTypes,3);
	   //Tap Expense Categories
	   home().tapExpenseCategories();
	   //verify the expense categories page is loaded
	   expenseCat().verifyExpenseCategoriesPage();
    ...
    /** Name : INV_MEC_017_INV_TI_046_Setup_Default_Categories_Add_New_Custom_Categories
	  * 
	  * Description : Set up expenses using default categories and add new custom categories and verify new category in product page
	  * 
	  * Manual Test cases : INV_MEC_017,INV_TI_046
	  * 
	  * Author : Gayathri Anand
	  * 
	  * Date : 10/04/2016
	  ...
	  *  
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1","CriticalBatchAndroid"}, description = "Setup Default Categories,Add New Custom Categoriesand verify new category in product page")
	 public void INV_MEC_017_INV_TI_046_Setup_Default_Categories_Add_New_Custom_Categories(ExpenseCategoriesObject data) throws Exception {	
    ...
    /** Name : INV_MEC_012_018_INV_TI_043_047_Setup_Suggested_Categories_Verify_Product_Categories_Add_New_Custom_Categories
	  ...
	  *  
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS2"}, description = "Setup Suggested Categories, Verify Product Categories")
	 public void INV_MEC_012_INV_TI_043_Setup_Suggested_Categories_Verify_Product_Categories(ExpenseCategoriesObject data) throws Exception {	
   ...
   /** Name : INV_MEC_012_018_INV_TI_043_047_Setup_Suggested_Categories_Verify_Product_Categories_Add_New_Custom_Categories
	  ...
	  *  
	  ******************************************************************************************/
 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Setup Suggested Categories,Add New Custom Categoriesand verify new category in product page")
	 public void INV_MEC_018_INV_TI_047_Setup_Suggested_Categories_Add_New_Custom_Categories(ExpenseCategoriesObject data) throws Exception {	
	
		//Login to app
	   component().login(data.strUserName, data.strPassword);
	   // precondition -INV_SI_004
	   ////////////
	   component().setupInventorywithOGDefaultLocSugg12Cat();
	   //Tap Expense Categories
	   home().tapExpenseCategories();
   ...
   /** Name : INV_MEC_013_019_INV_TI_044_048_Setup_Custom_Categories_Verify_Product_Categories_Add_New_Custom_Categories
	  ...
	  *  
	  ******************************************************************************************/
 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS2","CriticalBatchAndroid"}, description = "Setup custom Categories, Verify Product Categories,Add New Custom Categoriesand verify new category in product page")
	 public void INV_MEC_013_INV_TI_044_Setup_Custom_Categories_Verify_Product_Categories(ExpenseCategoriesObject data) throws Exception {	
  ...
  *  
  ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1","CriticalPatchIOS"}, description = "Setup custom Categories, Verify Product Categories,Add New Custom Categoriesand verify new category in product page")
 public void INV_MEC_019_INV_TI_048_Setup_Custom_Categories_Add_New_Custom_Categories(ExpenseCategoriesObject data) throws Exception {	

	//Login to app
   component().login(data.strUserName, data.strPassword);
   // precondition -INV_SI_005
   ////////////
   component().setupInventorywithOGDefaultLocCustomCategory(data.strCategoryNames,data.strCategoryTypes,3);
   //Tap Expense Categories
   home().tapExpenseCategories();
...
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"Invalid_SI_017"}, description = "Set up expenses using default categories after skipping expense category setup in initital setup")
...
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"Invalid_SI_017"}, description = "Set up expenses using suggested categories after skipping expense category setup in initital setup")
...
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"Invalid_SI_017"}, description = "Set up expenses using custom categories after skipping expense category setup in initital setup")
 ...
 *  
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1","CriticalBatchAndroid"},priority=1, description = "Create Manage expense - error verification")
