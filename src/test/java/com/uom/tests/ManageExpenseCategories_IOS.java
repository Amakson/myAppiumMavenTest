...
public class ManageExpenseCategories_IOS extends PageFactory{
    ...
    /******************************************************************************************
	  ...
	  ******************************************************************************************/
    @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategoriesDefect","ExpenseCategoriesIOS1"}, description = "Verify and Update Default Expense Categories and verify the changes in categories for location items")
   ...
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Delete Default Expense Categories and verify the changes in categories for location items")
    ...
    /******************************************************************************************
	  ...
	  *  
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategoriesDefect","ExpenseCategoriesIOS1"}, description = "Verify and Update and Suggested Expense Categories and verify the changes in categories for location items")
 ...
 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Delete Suggested Expense Categories and verify the changes in categories for location items")
   ...
   /******************************************************************************************
 	  ...
 	  *  
 	  ******************************************************************************************/
    @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategoriesDefect","ExpenseCategoriesIOS1"}, description = "Verify and Update Custom Expense Categories")
    ...
    /******************************************************************************************
	  ...
	  *  
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Delete Custom Expense Categories")
	  ...
	  *  
	  ******************************************************************************************/
    @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS2"}, description = "_Delete All Custom Categories, Setup Default Categories, Verify Product Categories")
    ...
    /** Name : INV_MEC_017_INV_TI_046_Setup_Default_Categories_Add_New_Custom_Categories
	  ...
	  *  
	  ******************************************************************************************/
   @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Setup Default Categories,Add New Custom Categoriesand verify new category in product page")
 ...
 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Setup Suggested Categories,Add New Custom Categoriesand verify new category in product page")
   ...
   /** Name : INV_MEC_013_019_INV_TI_044_048_Setup_Custom_Categories_Verify_Product_Categories_Add_New_Custom_Categories
	  ...
	  *  
	  ******************************************************************************************/
 @Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS2"}, description = "Setup custom Categories, Verify Product Categories,Add New Custom Categoriesand verify new category in product page")
  ...
  *  
  ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"}, description = "Setup custom Categories, Verify Product Categories,Add New Custom Categoriesand verify new category in product page")
 ...
 *  
 ******************************************************************************************/
@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"ExpenseCategories","ExpenseCategoriesIOS1"},priority=1, description = "Create Manage expense - error verification")
