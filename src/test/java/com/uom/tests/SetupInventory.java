...
public class SetupInventory extends PageFactory{
	 ...
	 *  
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory","CriticalPatchIOS"}, description = "Verify setup inventory is done correctly with Order guide setup, default location,default categories.")
	 ...
	 *  
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory"}, description = "Verify setup inventory is done correctly with custom Sysco list setup, custom location, custom categories.")
	 ...
	 *  
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory","CriticalPatchIOS"}, description = "Verify_Setup_Inventory_Setup_CustomList_MultipleList_Default_Loc_Default_Category_ItemsMultipleLocation")
	 ...
	 *  
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory"}, description = "Verify setup inventory setup is done correctly with OG+Default Loc+ Custom Category")
	...
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory","CriticalBatch1","CriticalPatchIOS"}, description = "Verify setup inventory setup is done correctly with OG+Custom Loc+ Custom Category")
	 ...
	 *  
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory"}, description = "Verify setup inventory setup is done correctly with OG+Custom Loc+ Default Category- Multiple location selection")
	 ...
	 *  
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory","CriticalBatch1"}, description = "Verify setup inventory setup is done correctly with Custom List(Multiple List - My lists)+Default Loc+Default Cat (Items Multiple Location)")
	 ...
	 *  
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory"}, description = "Verify setup inventory setup is done correctly with Shared List+Default Loc+Default Cat")
	 ...
	 *  
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory"}, description = "Verify setup inventory setup is done correctly with Custom list (Shared list)+Default Loc+Custom Categories")
	 ...
	 *  
	 ******************************************************************************************/
	@Test(retryAnalyzer = RetryAnalyzer.class,dataProvider="DP1",groups={"SetupInventory"}, description = "Verify setup inventory setup is done correctly with Order guide, Custom location and Custom category assigning	only some items and leaving other items without location or category")
